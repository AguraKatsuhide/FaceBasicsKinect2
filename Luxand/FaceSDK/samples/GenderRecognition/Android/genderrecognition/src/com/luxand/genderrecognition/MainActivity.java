...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private final String help_text = "GenderRecognition is as much a developer tool as it is a conceptual proof of technology showcasing Luxand FaceSDK";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int res = FSDK.ActivateLibrary("aCGamccfB6Uj3vlS7eDEryPnDrTbrZQb77ZHouPl3J8Q7o+BG4PcGevchFjppkWrVa038OU6Fghhy/BJfJV1n82InviCSijl8Vbxb11fs+VrcbSEfpESqjKSJQK8OLCqU0qYDy1oRHLRAg/3CHKCBzP/6IHuamy9Y/aY/xd1E7A=");
        if (res != FSDK.FSDKE_OK) {
            ...
            FSDK.SetTrackerMultipleParameters(mDraw.mTracker, "DetectGender=true;DetectExpression=false", errpos);
            if (errpos[0] != 0) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        */
        ...
        for (int i = 0; i < (int) face_count[0]; ++i) {
            ...
            mAttributeValues[i] = String.format("%s:%d%%", (confidenceMalePercent>confidenceFemalePercent)?"Male":"Female", Math.max(confidenceMalePercent, confidenceFemalePercent));
        }
